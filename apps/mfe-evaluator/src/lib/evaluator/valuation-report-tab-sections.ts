...
export const VALUATION_REPORT_TAB_SECTIONS: readonly ReportTabSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "للمباني والعقارات القائمة: يتم تقدير تكلفة المباني وعمر البناء الافتراضي حسب وضع السوق الحالي وبالاسترشاد بدليل الأسعار الاسترشادية الصادر من الهيئة السعودية للمقيمين المعتمدين، ويتم افتراض ان تكاليف البناء تشمل التكاليف المباشرة والغير مباشرة بحسب السعر السائد في السوق.",
