...
export const CASE_STUDY_ANSWER_LABEL_A = "فعال / مطابق / نعم";
export const CASE_STUDY_ANSWER_LABEL_B = "غيرفعال / غير مطابق / لا";
...
> = {
  deed: {
    colA: CASE_STUDY_ANSWER_LABEL_A,
    colB: CASE_STUDY_ANSWER_LABEL_B,
    colNa: CASE_STUDY_ANSWER_LABEL_B,
  },
  survey: {
    colA: CASE_STUDY_ANSWER_LABEL_A,
    colB: CASE_STUDY_ANSWER_LABEL_B,
