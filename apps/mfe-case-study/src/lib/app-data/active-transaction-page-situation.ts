import { filterTasksForCaseStudy, filterTasksForSystemUpload } from "@platform/app-shared/app-data/active-transactions";
  ...
  return [
    {
      key: "ready",
      label: "جاهزة للتقييم",
      sub: "بيانات المعاينة معتمدة — باشر التقييم",
      tone: "blue",
      icon: "play",
    },
    {
      ...
      sub: "بانتظار اعتماد الأخصائي لبيانات المعاينة",
      tone: "warn",
      icon: "clock",
    },
    {
      ...
      sub: "بانتظار الاستلام — ليس اعتماداً للقيمة",
      tone: "green",
      icon: "check",
    },
    {
