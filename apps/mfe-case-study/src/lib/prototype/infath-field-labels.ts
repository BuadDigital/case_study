...
export const INFATH_FIELD_LABELS = {
  ...
  movablesDescription: "وصف المنقولات",
  ...
  annexUpperCount: "ملحق علوي (عدد)",
  annexGroundCount: "ملحق أرضي (عدد)",
  ...
  independenceDeclared: "إقرار الاستقلالية وعدم تضارب المصالح",
  reportWorkers: "العاملون على التقرير",
