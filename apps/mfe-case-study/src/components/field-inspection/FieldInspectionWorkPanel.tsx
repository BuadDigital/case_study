...
export function FieldInspectionWorkPanel({
  ...
  submitting = false,
  onFailureSubmitted,
  forceReadOnly: _forceReadOnly = false,
}: {
  ...
  /** Kept for call-site compatibility; inspection tab is the HTML form surface. */
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col">
      ...
      {workTab === "inspection" ? (
        /* Case Study.html `pdInspectionHtml` — single-column cards, no study aside */
        <div className="min-h-0 flex-1 overflow-y-auto px-4 py-4 sm:px-6 sm:py-5">
          <div id="pdInspection" className="mx-auto max-w-[920px]">
            <FieldInspectionWorkBody
              def={def}
              task={task}
              hostRef={hostRef}
