...
> = {
  "field-inspection": {
    title: "أتعاب المعاين",
    intro:
      "بعد إنجاز العمل ارفع المعاملة للمشرف. البنود الجاهزة تُفوتر عبر كشف الأطراف.",
  ...
  "engineering-survey": {
    ...
    footer:
      "المكتب الهندسي جهة خارجية — الأتعاب مقابل الرفوعات المقبولة. الفوترة عبر كشف الأطراف الشهري.",
  },
  "court-visit": {
    title: "أتعاب زيارة المحكمة",
    intro:
      "أتعاب زيارات المحكمة تُسجل عند إتمام مهمة زيارة المحكمة. البنود الجاهزة تُفوتر عبر كشف الأطراف.",
    partyTypeColumn: "نوع المراجع",
    partyTypeEmployeeHint: "(متعاون فرد)",
    emptyLine: "لا توجد أتعاب مسجّلة بعد.",
    emptyHint:
      "تظهر بعد تعيين وإتمام زيارة محكمة من مهام العمليات.",
    tableHint:
      "ملخص أتعاب زيارات المحكمة المسندة إليك — ارفع للمشرف عند الإنجاز.",
    footer:
      "تصنيف المراجع الحكومي: متعاون فرد فقط. القيمة الافتراضية من جدول تسعير زيارة المحكمة، ولكل سجل على حدة.",
  },
};
