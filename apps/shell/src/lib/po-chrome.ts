...
const DASHBOARD: BreadcrumbSegment = {
  label: "لوحة التحكم",
  href: "/dashboard",
};

/** Nested PO trail after list (edit / workspace) — keeps دراسة الحالة + PO link. */
...
/** Case Study.html `setHeader('تفاصيل العقار', crumb(['أوامر العمل','عقارات '+po,'العقار']))` */
...
export function resolvePoChrome(pathname: string): PoChrome | null {
  ...
  // Case Study.html renderProperties:
