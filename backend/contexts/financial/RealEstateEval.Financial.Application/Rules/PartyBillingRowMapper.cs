...
public static class PartyBillingRowMapper
{
    public static PartyBillingReadyLineDto ToReadyDto(
    ...
    public static PartyBillingReadyLineDto ToCourtVisitReadyDto(CourtVisitFeeCharge charge)
    {
        ...
        return new PartyBillingReadyLineDto
        {
            ...
            TaskKind = WorkflowTaskKindValues.CourtVisit,
    ...
    public static List<PartyBillingRejectedInvoiceDto> ParseRejected(string? json)
    {
    ...
    public static string? SerializeRejected(IReadOnlyList<PartyBillingRejectedInvoiceDto> items)
    {
        if (items.Count == 0) return null;
        return System.Text.Json.JsonSerializer.Serialize(items);
    }

    public static List<Guid> ParseTaskIds(IReadOnlyList<string> raw) =>
 ...
 /// </summary>
    public static IEnumerable<InspectorFeeLedger> CollapseReadyLedgers(
    ...
    public static WorkflowTaskKind ParseKind(string? raw) =>
