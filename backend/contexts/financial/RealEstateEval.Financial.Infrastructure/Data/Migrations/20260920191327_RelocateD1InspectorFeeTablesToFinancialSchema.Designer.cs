...
namespace RealEstateEval.Financial.Infrastructure.Data.Contexts.Financial.Migrations
{
    ...
    [Migration("20260920191327_RelocateD1InspectorFeeTablesToFinancialSchema")]
    partial class RelocateD1InspectorFeeTablesToFinancialSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealEstateEval.Financial.Domain.IncentiveSuspension", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RealEstateEval.Financial.Domain.PartyFeePricingTable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RealEstateEval.Financial.Domain.PoEnfazFollowup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RealEstateEval.Financial.Domain.PoEnfazInvoice", b =>
                {
                    b.Property<string>("PoNumber")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("RealEstateEval.Financial.Domain.PartyBillingStatementLine", b =>
                {
                    b.HasOne("RealEstateEval.Financial.Domain.PartyBillingStatement", "Statement")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("RealEstateEval.Financial.Domain.PartyFeePricingAssignment", b =>
                {
                    b.HasOne("RealEstateEval.Financial.Domain.PartyFeePricingTable", "Table")
