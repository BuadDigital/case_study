...
internal sealed record PricingTableSnapshot(
    Guid Id,
    string Category,
    string Name,
    string PricingKind,
...
internal sealed record PricingTierSnapshot(
    int SortOrder,
    decimal? MaxAreaM2,
    decimal FeeSar);

internal sealed record PricingAssignmentSnapshot(Guid TableId, string AssigneeId);

internal static class PartyFeePricingSnapshots
{
    internal static PricingTableSnapshot Snapshot(PartyFeePricingTable table) =>
        Snapshot(
            table,
            table.AreaTiers
    ...
    internal static PricingTableSnapshot Snapshot(
