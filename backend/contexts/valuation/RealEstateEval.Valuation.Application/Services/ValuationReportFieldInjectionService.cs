...
/// <summary>
/// Builds the valuation-report field payload from live context — the parallel to uploading a
/// PDF, with the business logic staying here. Every collaborator is a port, so this file holds
/// composition and display rules only - no EF (solid-scorecard finding 1).
/// </summary>
public sealed class ValuationReportFieldInjectionService(
    IValuationRequestLookup valuationRequests,
    ICaseStudyLookup caseStudy,
    IValuationPrintableAttachmentLookup attachments,
    ...
    TimeProvider clock) : IValuationReportFieldInjectionService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var printable = await attachments.ListPrintableAsync(propertyId, cancellationToken);
    ...
    private static Dictionary<string, string?> BuildValueBag(
        ...
        IReadOnlyList<ReportAttachmentRef> printable,
        bool hasStructures,
