...
namespace RealEstateEval.Valuation.Infrastructure.Data.Contexts.Valuation.Migrations
{
    ...
    [Migration("20260906055720_RequestDateAsDateAndSelectionUpdatedAt")]
    partial class RequestDateAsDateAndSelectionUpdatedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealEstateEval.Valuation.Domain.ValuationAdjustmentFactorRationale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ValuationRequestId", "SelectionContext", "FactorKey")
                        .IsUnique()
                        .HasDatabaseName("IX_ValuationAdjFactorRationales_Request_Context_Factor");

                    b.ToTable("ValuationAdjustmentFactorRationales", "valuation");
                });
            ...
            modelBuilder.Entity("RealEstateEval.Valuation.Domain.ValuationReportIssuance", b =>
                {
                    ...
                    b.Property<DateTime?>("CertificateUploadedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("CertificateUploadedByUserId")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.Property<DateTime>("DepositIssuedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("DepositIssuedByUserId")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
