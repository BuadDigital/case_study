 ...
 // growth without affecting today's reports (newest first).
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new CaseStudyValuationPropertyContextDto
        {
            ...
            IdentifierType = PropertyIdentifierTypeLabels.ToApiValue(property.IdentifierType),
            DeedKind = DeedKindLabels.ToApiValue(property.DeedKind),
            DeedNumber = property.DeedNumber,
            RealEstateRegNumber = property.RealEstateRegNumber,
            RequiresEngineeringSurvey = SurveyRequirementRules.PropertyRequiresSurvey(property),
