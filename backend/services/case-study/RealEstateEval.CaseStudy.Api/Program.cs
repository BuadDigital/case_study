...
builder.Services.AddFinancialPersistence(builder.Configuration, connectionString);
...
builder.Services.AddAttachmentsPersistence(builder.Configuration, connectionString);
