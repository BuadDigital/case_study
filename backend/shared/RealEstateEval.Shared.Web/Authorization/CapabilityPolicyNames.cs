...
public static class CapabilityPolicyNames
{
 ...
 /// </summary>
    ...
    /// <summary>
    /// List/read the comparable bank and property links — appraisers, field parties, and case staff.
    /// </summary>
    public const string ReadComparableBank = "Capability:read-comparable-bank";
