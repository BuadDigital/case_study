...
/// <summary>
/// Withholds employee incentives for one user on one transaction (PO). Phase 1 is transaction-scoped;
/// <see cref="PeriodFrom"/> / <see cref="PeriodTo"/> are reserved for a later time-window mode.
/// Accrual still creates the ledger; ج٣ <c>suspended</c> status carries the withhold into payables.
/// </summary>
