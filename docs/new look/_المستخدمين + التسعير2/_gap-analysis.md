...
| البند المالي ودورة الصرف | **~١٠٠٪** (أ/ج + إيراد) | ج١–ج٩ مبنية؛ `PartyBillingStatement`؛ تفكيك ق٧؛ دورة إيراد إنفاذ MVP (إصدار→تحصيل + مفاتيح)؛ `DisbursementBatch` متقاعد (410)؛ التراث `disb-req` للقراءة/الصرف فقط |
