function renderKeyDetail(id){
    ...
    var chain=[{type:'receive_back', _initial:true, state:'completed', person:(e.receivedBy||'فراس كمرين'), role:'مراجع حكومي', date:e.created, letter:'', from:(e.scenario==='party'?('طرف آخر'+(e.sourceParty?': '+e.sourceParty:'')):e.court)}].concat(e.handoffs);
    var handoffPanel =
    ...
    var html=
      ...
      '<div class="pp-head">'+
        ...
        '<div class="pp-summary">'+
          ...
          '<div class="pp-cell"><div class="k">مستلم الظرف</div><div class="v">'+esc(e.receivedBy||'فراس كمرين')+'</div></div>'+
