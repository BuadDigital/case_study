function renderTasks(){
    var counts={created:0,in_progress:0,completed:0,cancelled:0};
    TASKS.forEach(function(t){ counts[t.status]=(counts[t.status]||0)+1; });
    var active=counts.created+counts.in_progress;
    ...
    document.getElementById('view-tasks').innerHTML =
      '<div class="kpi">'+
        ...
        '<div><div class="kpi-head"><span class="kpi-ico" style="background:color-mix(in srgb,'+NAVY+' 10%,transparent);color:'+NAVY+'"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v4M12 18v4M4.9 4.9l2.8 2.8M16.3 16.3l2.8 2.8M2 12h4M18 12h4"/></svg></span><span>منشأة</span></div><div class="kpi-num">'+counts.created+'</div><div class="kpi-sub">بانتظار البدء</div></div>'+
