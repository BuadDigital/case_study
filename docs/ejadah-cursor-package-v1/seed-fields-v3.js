// سجل حقول التقييم — الإصدار 3.0
// مبني على v2 (118 حقلًا) + قرارات جلسة 2026-08-12 (مراجعة التقرير + حسم المصادر الاثني عشر)
// مرجع القرارات: review-decisions-log-v2.md §4ب/§4ج · audit-report-v1.md
//
...
export const SEED_FIELDS = [
  ...
  { label: "نوع العقار المقارن", section: "بنك المقارنات", type: "قائمة اختيار", sourceKind: "دور بشري", sourceRef: "مقيم عقاري", responsible: ["مقيم مراجع"], correction: "تعديل مباشر", tags: ["بنك المقارنات"], required: true },
  { label: "نوع المقارن", section: "بنك المقارنات", type: "قائمة اختيار", sourceKind: "دور بشري", sourceRef: "مقيم عقاري", responsible: ["مقيم مراجع"], correction: "تعديل مباشر", tags: ["بنك المقارنات"], required: true },
  ...
  { label: "سعر المتر للمقارن", section: "بنك المقارنات", type: "مبلغ", sourceKind: "دور بشري", sourceRef: "مقيم عقاري", responsible: ["مقيم مراجع"], correction: "تعديل مباشر", tags: ["بنك المقارنات"], required: true },
...
export const SEED_FIELDS_V3_ADDITIONS = [
  ...
  { label: "رقم الإعلان", section: "بنك المقارنات", type: "نص", sourceKind: "دور بشري", sourceRef: "من المنصة — للعروض فقط، لا يُطبع", responsible: ["مقيم عقاري"], correction: "تعديل مباشر", tags: ["بنك المقارنات"], required: false },
  { label: "جوال المعلن", section: "بنك المقارنات", type: "نص", sourceKind: "دور بشري", sourceRef: "من المنصة — للعروض فقط، لا يُطبع", responsible: ["مقيم عقاري"], correction: "تعديل مباشر", tags: ["بنك المقارنات"], required: false },
  { label: "وصف السعر", section: "بنك المقارنات", type: "قائمة اختيار", sourceKind: "دور بشري", sourceRef: "حد · قابل للتفاوض — للعروض فقط", responsible: ["مقيم عقاري"], correction: "تعديل مباشر", tags: ["بنك المقارنات"], required: false },
  ...
  { label: "رقم الطلب", section: "نطاق العمل", type: "نص", sourceKind: "موروث", sourceRef: "إنفاذ: مرجع القضية بالمحكمة · عملاء آخرون: مرجعهم أو لا شيء — تحقق: ≠ رقم الصك", responsible: ["أخصائي دراسة الحالة"], correction: "اعتراض فقط", tags: ["تقييم"], required: false },
  { label: "تاريخ المعاينة", section: "نطاق العمل", type: "تاريخ", sourceKind: "محسوب", sourceRef: "ختم آلي من تطبيق الميداني لحظة إتمام المعاينة — آخر زيارة مكتملة", responsible: ["معاين"], correction: "اعتراض فقط", tags: ["تقييم", "محسوب"], required: true },
  // الأصل والعقار
