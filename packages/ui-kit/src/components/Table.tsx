...
export function Th({ className, ...props }: ThHTMLAttributes<HTMLTableCellElement>) {
  return (
    <th
      className={cn(
        "border-b-2 border-gold bg-surface-2 px-4 py-3.5 text-start text-xs font-bold text-heading whitespace-nowrap",
        className,
      )}
      {...props}
    />
...
export function ThAction({ className, ...props }: ThHTMLAttributes<HTMLTableCellElement>) {
  return (
    <th
      className={cn(
        "w-12 border-b-2 border-gold bg-surface-2 px-4 py-3.5 text-center text-xs font-bold text-heading whitespace-nowrap",
        className,
      )}
      {...props}
    />
