...
const poIntakeFields: PropertyFieldCatalogEntry[] = [
  ...
  { key: "assignmentDocFileNames", label: "خطاب الإسناد" },
...
const propertyDocumentsFields: PropertyFieldCatalogEntry[] = [
  ...
  { key: "docAssignmentDecree", label: "خطاب الإسناد (مستند)" },
...
const backendApiFields: PropertyFieldCatalogEntry[] = [
  ...
  { key: "WorkOrderProperty.AssignmentDocFileName", label: "خطاب الإسناد (API)" },
