...
const poIntakeFields: PropertyFieldCatalogEntry[] = [
  ...
  { key: "realEstateRegNumber", label: "تسجيل عيني" },
  { key: "realEstateRegDate", label: "تاريخ التسجيل العيني" },
  { key: "ownerName", label: "اسم المالك" },
  { key: "court", label: "المحكمة" },
  { key: "circuit", label: "الدائرة" },
  { key: "delegationLetterFileNames", label: "خطاب التكليف" },
  { key: "realEstateRegFileName", label: "السجل العقاري (مرفق)" },
  { key: "assignmentDocFileNames", label: "قرار الإسناد" },
  { key: "deedOwnershipFileName", label: "صورة وثيقة التملك (الصك)" },
  { key: "bourseDeedImageFileName", label: "صورة الصك من البورصة" },
...
const inspectorInfathFields: PropertyFieldCatalogEntry[] = [
  ...
  { key: "movablesDescription", label: "وصف المنقولات" },
  ...
  { key: "annexTotal", label: "إجمالي مساحة الملاحق (م²)" },
...
const inspectorFormKeyFields: PropertyFieldCatalogEntry[] = [
  ...
  { key: "annexTotalSqm", label: "مساحة الملاحق — مفتاح النموذج" },
...
const propertyDocumentsFields: PropertyFieldCatalogEntry[] = [
  ...
  { key: "docDelegationLetter", label: "خطاب التكليف (مستند)" },
  { key: "docDeedOwnership", label: "صورة وثيقة التملك (مستند)" },
...
const backendApiFields: PropertyFieldCatalogEntry[] = [
  ...
  { key: "WorkOrderProperty.RealEstateRegNumber", label: "تسجيل عيني (API)" },
  { key: "WorkOrderProperty.RealEstateRegDate", label: "تاريخ التسجيل العيني (API)" },
  ...
  { key: "WorkOrderProperty.DelegationLetterFileName", label: "خطاب التكليف (API)" },
  { key: "WorkOrderProperty.DeedOwnershipFileName", label: "صورة وثيقة التملك (API)" },
  { key: "WorkOrderProperty.BourseDeedImageFileName", label: "صورة الصك من البورصة (API)" },
